...

{
    ...
    internal class Program
    {
        ...
        private static void DoDeposit(Bank toBank)
        {
            ...
            DepositTransaction depositTransaction = new DepositTransaction(toAccount, toBank,amount);
        ...
        private static void DoWithdraw(Bank toBank)
        {
            ...
            decimal amount = decimal.Parse(Console.ReadLine());
            WithdrawTransaction transaction = new WithdrawTransaction(toAccount,toBank,amount);
        ...
        private static void Dotransaction( Bank toBank)
        {
           ...
           Console.WriteLine("\nEnter the transfer amount");
            decimal amount = decimal.Parse(Console.ReadLine());
            TransferTransaction transaction = new TransferTransaction( fromAccount,toAccount,toBank,amount);
            toBank.ExecuteTransaction(transaction);
